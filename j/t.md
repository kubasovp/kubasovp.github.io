...
head - обычно используется для проверки наличия ресурса, похож на get, но отсутствует тело ответа
```
...
### 9. Что может происходить в браузере, когда пользователь вводит
